...
See the section "Disable-wallet mode" to build NewYorkCoin Core without wallet.
...
with 4.8-built NewYorkCoin Core is needed follow the steps under "Berkeley DB" above.
