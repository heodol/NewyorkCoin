Newyorkcoin Core version 1.14.2 is now available from:

  <https://github.com/NewYorkCoinNYC/newyorkcoin/releases/tag/v1.14.0/>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/NewYorkCoinNYC/newyorkcoin/issues>
...
Newyorkcoin Core introduces pruning the blockchain in 1.14. Pruning
...
When Newyorkcoin Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in Newyorkcoin-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Newyorkcoin Core. This was added in conjunction with
