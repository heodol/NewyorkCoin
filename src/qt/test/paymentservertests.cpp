...
void PaymentServerTests::paymentServerTests()
{
    ...
    // NewYorkCoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for NewYorkCoin (as there is no actual maximum coins)
